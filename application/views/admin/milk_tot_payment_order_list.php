				...
				<div class="col-12">
					<div class="card">
						<div class="card-header">
							<h4>Total Payment Orders List</h4>
						</div>
						<div class="card-body">
							<form class="" action="<?php echo base_url('milkorder/total_paymet_order_list'); ?>" method="post">
							<div class="row">
									<div class="col-md-3">
										...
										<?php if($tot_status==1){
											foreach($tot_list as $order){?>
												<tr>
													...
													<td><?php if($order->admin_accept_status==1){ echo 'Accepted'; }else if($order->admin_accept_status==2){ echo "Rejected"; }else{ echo "Pending"; } ?></td>
													<td>
