									...
									<?php  if($cstatus==1){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php 
												echo base_url('category/delete_category/').base64_encode($cat->cat_id);?>" class="btn btn-danger btn-action" data-toggle="tooltip" data-original-title="Delete"><i class="ion ion-trash-b"></i></a>
                                            </td>
                                        </tr>
										<?php $count++;
									endforeach;}?>
