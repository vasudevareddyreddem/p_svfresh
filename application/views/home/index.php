            ...
            <div class="category-featured">
              ...
              <div class="category-banner">
                <div class="col-sm-6 banner">
                  <a href="#"><?php if(!empty($c->cat_lh_img) && file_exists('assets/uploads/category_pics/'.$c->cat_lh_img)){ ?><img alt="ads2" class="img-responsive" src="<?php echo base_url('assets/uploads/category_pics/'.$c->cat_lh_img); ?>" /><?php } ?></a>
                </div>
                <div class="col-sm-6 banner">
                  <a href="#"><?php if(!empty($c->cat_rh_img) && file_exists('assets/uploads/category_pics/'.$c->cat_rh_img)){ ?><img alt="ads2" class="img-responsive" src="<?php echo base_url('assets/uploads/category_pics/'.$c->cat_rh_img);?>" /><?php } ?></a>
                </div>
              </div>
